...
FomadonDeveloper::FomadonDeveloper(Film *film)
{ // Constructor with parameters
    _film = *film;
}

FomadonDeveloper::FomadonDeveloper(Film *film, float temperature)
{ // Constructor with parameters
    _film = *film;
...
Film FomadonDeveloper::getFilm() { return _film; }
void FomadonDeveloper::setFilm(Film *film)
{
    _film = *film;
}

float FomadonDeveloper::getTemperature() { return _temperature; }
void FomadonDeveloper::setTemperature(float temperature) { _temperature = temperature; }
long FomadonDeveloper::getAgitationInitialSeconds() { return agitationInitialSeconds; }
long FomadonDeveloper::getAgitationSeconds() { return agitationSeconds; }
int FomadonDeveloper::getAgitationIntervalSeconds() { return agitationIntervalSeconds; }
